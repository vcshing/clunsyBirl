var game = {
    ...
    onload: function() {
        return me.video.init(900, 600, {
            ...
            scale: "auto",
            scaleMethod: "fit"
        }) ? (me.audio.init("mp3,ogg"), me.loader.onload = this.loaded.bind(this), me.loader.preload(game.resources), me.state.change(me.state.LOADING), void(document.location.hash.match("debug") && window.onReady(function() {
...
game.HUD = game.HUD || {}, game.HUD.Container = me.Container.extend({
    ...
    draw: function(a) {
        game.data.start && me.state.isCurrent(me.state.PLAY) && this.stepsFont.draw(a, game.data.steps, me.video.renderer.getWidth() / 2, 10)
    }
});
...
game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        this.logo = new me.Sprite(me.game.viewport.width / 2 - 170, -a, {
            image: a
    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new me.Sprite(me.video.renderer.getWidth() / 2 - a.width / 2, me.video.renderer.getHeight() / 2 - a.height / 2 - 100, {
            image: a
        }), 12);
        ...
        me.game.world.addChild(new me.Sprite(me.video.renderer.getWidth() / 2 - b.width / 2, me.video.renderer.getHeight() / 2 - b.height / 2, {
            image: b
        }), 10), me.game.world.addChild(new BackgroundLayer("bg", 1)), this.ground1 = me.pool.pull("ground", 0, me.video.renderer.getHeight() - 96), this.ground2 = me.pool.pull("ground", me.video.renderer.getWidth(), me.video.renderer.getHeight() - 96), me.game.world.addChild(this.ground1, 11), me.game.world.addChild(this.ground2, 11);
        var c = me.video.renderer.getHeight() / 2 + 200;
        if (this.share = new Share(me.video.renderer.getWidth() / 2 - 180, c), me.game.world.addChild(this.share, 12), this.tweet = new Tweet(this.share.pos.x + 170, c), me.game.world.addChild(this.tweet, 12), game.data.newHiScore) {
            var d = new me.Sprite(235, 355, {
        ...
        this.dialog = new(me.Renderable.extend({
            init: function() {
                this._super(me.Renderable, "init", [0, 0, 100, 100]), this.font = new me.Font("gamefont", 40, "black", "left"), this.steps = "Steps: " + game.data.steps.toString(), this.topSteps = "Higher Step: " + me.save.topSteps.toString()
            },
            draw: function(a) {
